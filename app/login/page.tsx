        ...
        <div className="hidden w-1/2 flex-col justify-between bg-muted/50 p-12 lg:flex">
          ...
          <div className="max-w-lg">
            ...
            <p className="text-2xl font-semibold leading-snug tracking-tight">
              <span className="text-muted-foreground">{t.auth.testimonialHighlight}</span>{" "}
              {t.auth.testimonialBody}
            </p>
            <div className="mt-8 flex items-center gap-3">
              ...
              <div>
                <p className="text-sm font-medium">{t.auth.testimonialRole}</p>
                <p className="text-xs text-muted-foreground">{t.auth.testimonialTeam}</p>
              </div>
            </div>
          </div>
